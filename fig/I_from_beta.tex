...
\pgfplotstableset{
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=1pt, mark size=1.2pt, solid] plot [error bars/.cd, y dir = both, y explicit,x dir = both, x explicit] table [ x=beta, y=n1] {../data/I.tsv};
		\addlegendentry{$N=1$}

		\addplot +[mark=*, line width=1pt, mark size=1.2pt, solid] plot [error bars/.cd, y dir = both, y explicit,x dir = both, x explicit] table [ x=beta, y=n4] {../data/I.tsv};
		\addlegendentry{$N=4$}

		\addplot +[mark=*, line width=1pt, mark size=1.2pt, solid] plot [error bars/.cd, y dir = both, y explicit,x dir = both, x explicit] table [ x=beta, y=n32] {../data/I.tsv};
		\addlegendentry{$N=32$}
